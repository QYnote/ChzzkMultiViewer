...
- **즐겨찾기 보관함** — 자주 보는 스트리머 영구 저장, LIVE 여부 표시 및 시청 목록 복사
...
- [x] 시청 목록 수동 추가 시 시청 목록 탭으로 자동 이동하는 동작 제거
- [x] 팔로잉 목록에서 이미 즐겨찾기에 등록된 항목의 표시를 "저장됨"에서 "즐겨찾기"로 변경 (아이콘 색상 변경은 유지, 텍스트만 수정)
- [ ] 시청 목록에 등록된 스트리머를 즐겨찾기에도 추가할 수 있는 기능 추가 (버튼 증가에 따른 표시 UI 추가 구상 필요)
- [x] 즐겨찾기 목록에 등록된 스트리머의 LIVE 여부 표시 기능 추가
