[설계서](../../README.md) › [Logical-Viewpoint](README.md) › Platforms
...
| 방송 화면 주소 만들기 | 채널 | 방송 화면 주소 | 없음 |

- 방송 화면 주소에는 **확장 프로그램이 만든 화면임을 알리는 표시를 붙인다.** 플랫폼과 무관한 공통 규칙이며, 방송 화면 안에서 도는 스크립트가 이 표시를 보고 자기가 붙을 화면인지 판별한다.
