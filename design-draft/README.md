...
| 문서 | 다루는 내용 |
|---|---|
| [Overview](Overview.md) | 기능 개요 (기능 영역별) |
| [Architecture](Architecture.md) | 계층 구성 · 의존 방향 · 통신 규칙 |
| [Build](Build.md) | 빌드/배포 환경 · 실패 대응 |
| [Git](Git.md) | Git 브랜치 전략 · 커밋/배포 절차 · 버전 규칙 |
| [Changelog](Changelog.md) | 버전 수정 내역 |
